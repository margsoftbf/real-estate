...
const DollarSquareBold: FC<IconProps> = ({
  size = 24,
  className = '',
  color = 'currentColor',
  ...props
  ...
  return (
    ...
    >
      <path
        d="M11.25 8.08008V10.9401L10.24 10.5901C9.72998 10.4101 9.41998 10.2401 9.41998 9.37008C9.41998 8.66008 9.94998 8.08008 10.6 8.08008H11.25Z"
        fill={color}
      />
      <path
