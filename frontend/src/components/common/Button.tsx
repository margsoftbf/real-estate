...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      'inline-flex items-center justify-center rounded-lg transition-all duration-300 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-jakarta';
    ...
    const primaryStyles =
      variant === 'primary'
        ? {
            ...
            borderColor: 'var(--color-primary-violet)',
            color: 'white',
          }
        : {};
